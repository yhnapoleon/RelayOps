...
RelayOps ships local synthetic services and intentionally public demo credentials. Compose publishes services only on `127.0.0.1`. Do not expose the monitoring controls, or mock application APIs to the internet.
